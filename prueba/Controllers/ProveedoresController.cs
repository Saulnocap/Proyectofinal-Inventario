...
namespace prueba.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        {
            var proveedores = from prueba in _context.Proveedores select prueba;
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,ProvCode")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,ProvCode")] Proveedore proveedore)
        {
            if (id != proveedore.Id)
            {
                return NotFound();
